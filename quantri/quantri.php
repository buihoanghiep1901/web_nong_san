...
<html>
    <head>
        ...
        <title>ADMIN Thế Giới Nông Sản</title>
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./quantri.php"><span>Thế Giới Nông Sản</span>Admin</a>
                    <ul class="user-menu">
                        <li class="dropdown pull-right">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="./quantri.php?page_layout=suatv&id=<?php 
                                    $email=$_SESSION['email'];
                                    $sql =" SELECT id FROM user WHERE email='$email'" ;
                                    $result = $conn->query($sql);
                                    $row=$result->fetch_array();
                                    echo $row['id'];
                                ?>"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Thông tin thành viên</a></li>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="./quantri.php?page_layout=feedback">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            if(isset($_GET["page_layout"])){
                switch ($_GET["page_layout"]) {
                    case 'danhsachtv':include_once './chucnang/thanhvien/danhsachtv.php';
                        break;
                    ...
                    case 'suadm':include_once './chucnang/danhmuc/suadm.php';
                        break;
                    case 'feedback':include_once './chucnang/feedback/feedback.php';
                        break;
                }
            }else{
